...
data_path = '/disk2/zhanglingming/Flask_Server/Flask_Server/dispatcher_server/data/'
...
dispatcher_server_logger_path = '/disk2/zhanglingming/Flask_Server/Flask_Server/dispatcher_server/log/dispatcher_server.log'
...
#----------------------------------------------------------------------------------------------------
dispatcher_server_api = '/dispatcher_server/api'

dispatcher_server_api_req = {
                                "time": str,
                                "device_id": str,
                                "data_type": str,
                                "data_size": int,
...
dispatcher_server_api_res = {
                                "code": int,  #定义调用状态的返回码用于判断结果返回成功与否
                                "message": str, #接口调用状态返回信息
                                "result":list,
                            }   
#-------------------------------------------------------------------------------------------
# this is a demo of frontend api
